...
class TestBot(ch.RoomManager):
  ...
  def findUser(self, args):
          ...
          if "buyer" in stuff:
                  return "<f x12FF0000='1'>%s <f x12D6061E='1'>Ini adalah pengguna." % args.title()
          elif "group" in stuff:
                  return "<f x12FF0000='1'> %s <f x12D6061E='1'>adalah chatting, Link internal Anda: <f x12FF0000='1'>%s" % (args.title(), ch.getServer(args))
...
############################################################### UNLOCK/LOCK BOT ######################################################################
        ...
        if cmd == "lock" and self.getAccess(room, user) >= 4:
          self.getRoom("animaiden-net").message("<f x12D6061E='1'><br/><br/>[<f x12FF0000='0'>S<f x12FF4C00='0'>T<f x12FF9800='0'>A<f x12FFE400='0'>T<f x12B3FF00='0'>U<f x1267FF00='0'>S<f x12BFF00='0'> <f x1200FF4C='0'>C<f x1200FF98='0'>M<f x1200FFE4='0'>D<f x12D6061E='1'>]<f x12D6061E='1'><br/><br/><br/>Usuário: <f x12FF0000='1'>%s <f x12D6061E='1'><br/>Chat: <f x12FF0000='1'>%s  <f x12D6061E='1'><br/>Comando: <f x12FF0000='1'>%s <f x12D6061E='1'><br/>IP: <f x12FF0000='1'>%s" % (user.name, room.name, cmd, message.ip), True)    
          if args in locks:
            room.message("Room is <f x12FF0000='1'> [LOCKED] ", True)
            return
          ...
          if args == "":
            if room.name in locks:
              room.message("Room Chatting ini sudah <f x12FF0000='1'> [LOCKED] ", True)
              return
            locks.append(room.name)
            room.message("done Rooms  <f x12FF0000='1'> %s   <f x12D6061E='1'> is <f x12FF0000='1'> [LOCKED] " % room.name, True)
          if args not in self.roomnames:
            if args == "": return
            room.message("sumimasen kamu bukan moderator di sini :| <f x12FF0000='1'> %s ."% args, True)
            return
...
######################################################### REGISTRO  BOT ##############################################################################
          ...
          if args == "":
            rank = self.getAccess(room, user)
            if rank == 1:
              self.getRoom("animaiden-net").message("<f x12A498AC='1'><br/><br/>[<f x12FF0000='0'>S<f x12FF4C00='0'>T<f x12FF9800='0'>A<f x12FFE400='0'>T<f x12B3FF00='0'>U<f x1267FF00='0'>S<f x12BFF00='0'> <f x1200FF4C='0'>C<f x1200FF98='0'>M<f x1200FFE4='0'>D<f x12A498AC='1'>]<f x12A498AC='1'><br/> <f x12A498AC='1'><br/><b>Chat</b>: <f x12FF0000='1'>%s  <f x12A498AC='1'><br/><b>Comando</b>: <f x12FF0000='1'>%s - %s  <f x12A498AC='1'><br/><b>IP</b>: <f x12FF0000='1'>%s" % (room.name, cmd, user.name, message.ip), True)    
        ...
        elif cmd == "unwl" and self.getAccess(room, user) >= 2:
          if args == "":
             rank = self.getAccess(room, ch.User(args))
             if rank == 2:
                registered.remove(args)
                self.getRoom("animaiden-net").message("<f x12D6061E='1'><br/><br/>[<f x12FF0000='0'>S<f x12FF4C00='0'>T<f x12FF9800='0'>A<f x12FFE400='0'>T<f x12B3FF00='0'>U<f x1267FF00='0'>S<f x12BFF00='0'> <f x1200FF4C='0'>C<f x1200FF98='0'>M<f x1200FFE4='0'>D<f x12D6061E='1'>]<f x12D6061E='1'><br/><br/><br/>Usuário: <f x12FF0000='1'>%s <f x12D6061E='1'><br/>Chat: <f x12FF0000='1'>%s  <f x12D6061E='1'><br/>Comando: <f x12FF0000='1'>%s - %s  <f x12D6061E='1'><br/>IP: <f x12FF0000='1'>%s" % (user.name, room.name, cmd, args, message.ip), True)    
                room.message(args+" Anda telah dihapus dari daftar pengguna terdaftar.", True)
             if rank == 2:
                room.message(args+" Anda telah dihapus dari daftar pengguna.", True)
...
########################################################## DEFINITION ######################################################################################
           ...
           try:
             ...
             if len(word.split()) > 4:
              ...
              if word in dictionary:
                 definition, name = json.loads(dictionary[word])
                 room.message("<br/><br/><br/> ID :  <f x12FF0000='1'>  %s  <br/> <f x12D6061E='1'>   Palavra chave :   <f x12990099='1'>  %s  <br/> <f x12D6061E='1'>  Definição: <f x12FF6600='1'>  %s " % (name, word, definition),True)
              else:
                 room.message("<f x12FF0000='1'>"+args+" <f x12D6061E='1'> Hal ini tidak diatur.", True)
           except:
         ...
         if self.getAccess(room, user) > 0:
          try:
            ...
            if word in dictionary:
              ...
              if self.getAccess(room, user) > 0:
                del dictionary[word]
                room.message(" <f x12D6061E='1'>defination <f x12FF0000='1'>"+word+" <f x12D6061E='1'> Itu dihapus dari database.", True)
                return
              else:
                room.message("<f x12FF0000='1'>user  %s   <f x12D6061E='1'> Anda tidak diizinkan untuk menggunakan ini :| " % user.name, True)
                return
            else:
          ...
          for i in dictionary:
            if user.name in dictionary[i]:
              arr.append(i)
          if len(arr) > 0:
            room.message("<f x12FF0000='1'> "+user.name+"    <f x12D6061E='1'> Anda memiliki <f x12FF0000='1'>  "+str(len(arr))+"   <f x12D6061E='1'> tidak ada definiont Ditambahkan pengaturan di sistem saya :  <f x12FF0000='1'>  %s  "% (', '.join(sorted(arr))), True)
          else:
...
################################################## ROOMS #################################################################################  
        ...
        if cmd == "leave" and self.getAccess(room, user) >= 5:
            if args == "":
              ...
              self.getRoom("animaiden-net").message("<f x12D6061E='1'><br/><br/>[<f x12FF0000='0'>S<f x12FF4C00='0'>T<f x12FF9800='0'>A<f x12FFE400='0'>T<f x12B3FF00='0'>U<f x1267FF00='0'>S<f x12BFF00='0'> <f x1200FF4C='0'>C<f x1200FF98='0'>M<f x1200FFE4='0'>D<f x12D6061E='1'>]<f x12D6061E='1'><br/><br/><br/>Usuário: <f x12FF0000='1'>%s <f x12D6061E='1'><br/>Chat: <f x12FF0000='1'>%s  <f x12D6061E='1'><br/>Comando: <f x12FF0000='1'>%s - %s  <f x12D6061E='1'><br/>IP: <f x12FF0000='1'>%s" % (user.name, room.name, cmd, room.name, message.ip), True)
          ...
          if room.name not in locks:
            roomlock = "<f x1233FF33='1'>Terkunci"
            room.message("<br/><br/><br/><f x12FF0000='1'>[ ★ LOCKSTATUS ★] <br/><f x12D6061E='1'>[Chat]: "+roomlock+"<br/><f x12D6061E='1'>[SimSimi]: <f x12FF0000='1'>diblokir ", True)
          if room.name in locks : 
            roomlock = "<f x12FF0000='1'>Diblokir"
            room.message("<br/><br/><br/><f x12FF0000='1'>[ ★ LOCKSTATUS ★] <br/><f x12D6061E='1'>[Chat]: "+roomlock+"<br/><f x12D6061E='1'>[SimSimi]: <f x12FF0000='1'>diblokir ", True)
##########################################################################################################################################
################################################## SYSTEN ################################################################################ 
...
#           try:
            ...
            if rank == -1:
              ...
              room.message(" <f x12FF0000='1'>  "+target.title()+"   <f x12D6061E='1'> ,User anda berada di   <f x11FF0000='1'> [-1 - BLACKLIST]    <f x11000000='1'>  Sekarang :D. ", True)
...
################################################################# NICKS ##################################################################
        ...
        ## if user.name in reg or user.name in friends or user.name in trusted or user.name in owners:
            if args:
                ...
                user = user.name 
                nicks[user] = json.dumps(nick)
                room.message("<f x11FF0000='1'> "+user+"   <f x11000000='1'> mulai sekarang Restia akan memanggilmu <f x11FF0000='1'> "+str(args)+" ", True)
                try: 
                    print("[SAVING] NICKS...")
                    f = open("nicks.txt", "w")
                    for user in nicks:
          ...
          try:
            if args in nicks:
              room.message("nick dari <f x11FF0000='1'>"+args+" <f x11000000='1'> is :<f x11FF0000='1'>"+sntonick(args), True)
            else:
...
######################################################## GOOGLE ##########################################################################
        ...
        if cmd == "gs" and self.getAccess(room, user) >= 2: 
            room.message("Search Google for : ( <f x12FF0000='1'>"+args+"  <f x12D6061E='1'> ) <br/><br/>"+gs(args),True) 

        if cmd == "gis" and self.getAccess(room, user) >= 2:
            room.message("Search Google image for : ( <f x12FF0000='1'>"+args+" <f x12D6061E='1'> ) <br/><br/>"+gis(args),True) 
...
################################################## CHATANGO SPECIAL ######################################################################
          ...
          if not "buyer" in url:
            ...
            if offline:
             if rank == 0:
                 room.message("<br/><br/>[<f x13FF0000='0'>P<f x13FF6D00='0'>R<f x13FFDA00='0'>O<f x1392FF00='0'>F<f x1325FF00='0'>I<f x1300FF6D='0'>L<f x1300FFDA='0'>E<f x13D6061E='1'>]<br/>"+picture+"<br/> <f x13D6061E='1'>Usuário: <f x13FF0000='1'>"+args+"<br/><f x13D6061E='1'>Sexo: <f x13FF0000='1'>"+gender+"<br/><f x13D6061E='1'>Idade: <f x13FF0000='1'>"+age+"<br/><f x13D6061E='1'> País: <f x13FF0000='1'>"+location+" <f x13D6061E='1'><br/>Rank: <f x1381BEF7='1'> [0 - Unranked] <f x13FF0040='1'>"+"<br/><f x13D6061E='1'> Status:<f x13FF0000='1'> Offline"+"<br/> <f x13D6061E='1'> Perfil completo: <f x136666CC='1'> http://barrykun.com/?"+args+"<f x13D6061E='1'> ou <f x136666CC='1'> http://"+args+".chatango.com", True)
             if rank == 1:
                 room.message("<br/><br/>[<f x13FF0000='0'>P<f x13FF6D00='0'>R<f x13FFDA00='0'>O<f x1392FF00='0'>F<f x1325FF00='0'>I<f x1300FF6D='0'>L<f x1300FFDA='0'>E<f x13D6061E='1'>]<br/>"+picture+"<br/> <f x13D6061E='1'>Usuário: <f x13FF0000='1'>"+args+"<br/><f x13D6061E='1'>Sexo: <f x13FF0000='1'>"+gender+"<br/><f x13D6061E='1'>Idade: <f x13FF0000='1'>"+age+"<br/><f x13D6061E='1'> País: <f x13FF0000='1'>"+location+" <f x13D6061E='1'><br/>Rank: <f x13D6061E='1'> [1 - Whitelist] <f x13FF0040='1'>"+"<br/><f x13D6061E='1'> Status:<f x13FF0000='1'> Offline"+"<br/> <f x13D6061E='1'> Perfil completo: <f x136666CC='1'> http://barrykun.com/?"+args+"<f x13D6061E='1'> ou <f x136666CC='1'> http://"+args+".chatango.com", True)
             if rank == 2:
                 room.message("<br/><br/>[<f x13FF0000='0'>P<f x13FF6D00='0'>R<f x13FFDA00='0'>O<f x1392FF00='0'>F<f x1325FF00='0'>I<f x1300FF6D='0'>L<f x1300FFDA='0'>E<f x13D6061E='1'>]<br/>"+picture+"<br/> <f x13D6061E='1'>Usuário: <f x13FF0000='1'>"+args+"<br/><f x13D6061E='1'>Sexo: <f x13FF0000='1'>"+gender+"<br/><f x13D6061E='1'>Idade: <f x13FF0000='1'>"+age+"<br/><f x13D6061E='1'> País: <f x13FF0000='1'>"+location+" <f x13D6061E='1'><br/>Rank: <f x1300A3EF='1'> [2 - Registered] <f x13FF0040='1'>"+"<br/><f x13D6061E='1'> Status:<f x13FF0000='1'> Offline"+"<br/> <f x13D6061E='1'> Perfil completo: <f x136666CC='1'> http://barrykun.com/?"+args+"<f x13D6061E='1'> ou <f x136666CC='1'> http://"+args+".chatango.com", True)
             if rank == 3:
                 room.message("<br/><br/>[<f x13FF0000='0'>P<f x13FF6D00='0'>R<f x13FFDA00='0'>O<f x1392FF00='0'>F<f x1325FF00='0'>I<f x1300FF6D='0'>L<f x1300FFDA='0'>E<f x13D6061E='1'>]<br/>"+picture+"<br/> <f x13D6061E='1'>Usuário: <f x13FF0000='1'>"+args+"<br/><f x13D6061E='1'>Sexo: <f x13FF0000='1'>"+gender+"<br/><f x13D6061E='1'>Idade: <f x13FF0000='1'>"+age+"<br/><f x13D6061E='1'> País: <f x13FF0000='1'>"+location+" <f x13D6061E='1'><br/>Rank: <f x13A9D0F5='1'> [3 - Assistant] <f x13FF0040='1'>"+"<br/><f x13D6061E='1'> Status:<f x13FF0000='1'> Offline"+"<br/> <f x13D6061E='1'> Perfil completo: <f x136666CC='1'> http://barrykun.com/?"+args+"<f x13D6061E='1'> ou <f x136666CC='1'> http://"+args+".chatango.com", True)
             if rank == 4:
                 room.message("<br/><br/>[<f x13FF0000='0'>P<f x13FF6D00='0'>R<f x13FFDA00='0'>O<f x1392FF00='0'>F<f x1325FF00='0'>I<f x1300FF6D='0'>L<f x1300FFDA='0'>E<f x13D6061E='1'>]<br/>"+picture+"<br/> <f x13D6061E='1'>Usuário: <f x13FF0000='1'>"+args+"<br/><f x13D6061E='1'>Sexo: <f x13FF0000='1'>"+gender+"<br/><f x13D6061E='1'>Idade: <f x13FF0000='1'>"+age+"<br/><f x13D6061E='1'> País: <f x13FF0000='1'>"+location+" <f x13D6061E='1'><br/>Rank: <f x139F81F7='1'> [4 - Mod] <f x13FF0040='1'>"+"<br/><f x13D6061E='1'> Status:<f x13FF0000='1'> Offline"+"<br/> <f x13D6061E='1'> Perfil completo: <f x136666CC='1'> http://barrykun.com/?"+args+"<f x13D6061E='1'> ou <f x136666CC='1'> http://"+args+".chatango.com", True)
             if rank == 5:
                 room.message("<br/><br/>[<f x13FF0000='0'>P<f x13FF6D00='0'>R<f x13FFDA00='0'>O<f x1392FF00='0'>F<f x1325FF00='0'>I<f x1300FF6D='0'>L<f x1300FFDA='0'>E<f x13D6061E='1'>]<br/>"+picture+"<br/> <f x13D6061E='1'>Usuário: <f x13FF0000='1'>"+args+"<br/><f x13D6061E='1'>Sexo: <f x13FF0000='1'>"+gender+"<br/><f x13D6061E='1'>Idade: <f x13FF0000='1'>"+age+"<br/><f x13D6061E='1'> País: <f x13FF0000='1'>"+location+" <f x13D6061E='1'><br/>Rank: <f x13FE9A2E='1'> [5 - Admin] <f x13FF0040='1'>"+"<br/><f x13D6061E='1'> Status:<f x13FF0000='1'> Offline"+"<br/> <f x13D6061E='1'> Perfil completo: <f x136666CC='1'> http://barrykun.com/?"+args+"<f x13D6061E='1'> ou <f x136666CC='1'> http://"+args+".chatango.com", True)
             if rank == 6:
                 room.message("<br/><br/>[<f x13FF0000='0'>P<f x13FF6D00='0'>R<f x13FFDA00='0'>O<f x1392FF00='0'>F<f x1325FF00='0'>I<f x1300FF6D='0'>L<f x1300FFDA='0'>E<f x13D6061E='1'>]<br/>"+picture+"<br/> <f x13D6061E='1'>Usuário: <f x13FF0000='1'>"+args+"<br/><f x13D6061E='1'>Sexo: <f x13FF0000='1'>"+gender+"<br/><f x13D6061E='1'>Idade: <f x13FF0000='1'>"+age+"<br/><f x13D6061E='1'> País: <f x13FF0000='1'>"+location+" <f x13D6061E='1'><br/>Rank: <f x13FE2EF7='1'> [6 - Developer] <f x13FF0040='1'>"+"<br/><f x13D6061E='1'> Status:<f x13FF0000='1'> Offline"+"<br/> <f x13D6061E='1'> Perfil completo: <f x136666CC='1'> http://barrykun.com/?"+args+"<f x13D6061E='1'> ou <f x136666CC='1'> http://"+args+".chatango.com", True)
            rank = self.getAccess(room, ch.User(args))
            if not offline:
             if rank == 0:
                 room.message("<br/><br/>[<f x13FF0000='0'>P<f x13FF6D00='0'>R<f x13FFDA00='0'>O<f x1392FF00='0'>F<f x1325FF00='0'>I<f x1300FF6D='0'>L<f x1300FFDA='0'>E<f x13D6061E='1'>]<br/>"+picture+"<br/> <f x13D6061E='1'>Usuário: <f x13FF0000='1'>"+args+"<br/><f x13D6061E='1'>Sexo: <f x13FF0000='1'>"+gender+"<br/><f x13D6061E='1'>Idade: <f x13FF0000='1'>"+age+"<br/><f x13D6061E='1'> País: <f x13FF0000='1'>"+location+" <f x13D6061E='1'><br/>Rank: <f x1381BEF7='1'> [0 - Unranked] <f x13FF0040='1'>"+"<br/><f x13D6061E='1'> Status:<f x1333FF33='1'> Online"+"<br/> <f x13D6061E='1'> Perfil completo: <f x136666CC='1'> http://barrykun.com/?"+args+"<f x13D6061E='1'> ou <f x136666CC='1'> http://"+args+".chatango.com", True)
             if rank == 1:
                 room.message("<br/><br/>[<f x13FF0000='0'>P<f x13FF6D00='0'>R<f x13FFDA00='0'>O<f x1392FF00='0'>F<f x1325FF00='0'>I<f x1300FF6D='0'>L<f x1300FFDA='0'>E<f x13D6061E='1'>]<br/>"+picture+"<br/> <f x13D6061E='1'>Usuário: <f x13FF0000='1'>"+args+"<br/><f x13D6061E='1'>Sexo: <f x13FF0000='1'>"+gender+"<br/><f x13D6061E='1'>Idade: <f x13FF0000='1'>"+age+"<br/><f x13D6061E='1'> País: <f x13FF0000='1'>"+location+" <f x13D6061E='1'><br/>Rank: <f x13D6061E='1'> [1 - Whitelist] <f x13FF0040='1'>"+"<br/><f x13D6061E='1'> Status:<f x1333FF33='1'> Online"+"<br/> <f x13D6061E='1'> Perfil completo: <f x136666CC='1'> http://barrykun.com/?"+args+"<f x13D6061E='1'> ou <f x136666CC='1'> http://"+args+".chatango.com", True)
             if rank == 2:
                 room.message("<br/><br/>[<f x13FF0000='0'>P<f x13FF6D00='0'>R<f x13FFDA00='0'>O<f x1392FF00='0'>F<f x1325FF00='0'>I<f x1300FF6D='0'>L<f x1300FFDA='0'>E<f x13D6061E='1'>]<br/>"+picture+"<br/> <f x13D6061E='1'>Usuário: <f x13FF0000='1'>"+args+"<br/><f x13D6061E='1'>Sexo: <f x13FF0000='1'>"+gender+"<br/><f x13D6061E='1'>Idade: <f x13FF0000='1'>"+age+"<br/><f x13D6061E='1'> País: <f x13FF0000='1'>"+location+" <f x13D6061E='1'><br/>Rank: <f x1300A3EF='1'> [2 - Registered] <f x13FF0040='1'>"+"<br/><f x13D6061E='1'> Status:<f x1333FF33='1'> Online"+"<br/> <f x13D6061E='1'> Perfil completo: <f x136666CC='1'> http://barrykun.com/?"+args+"<f x13D6061E='1'> ou <f x136666CC='1'> http://"+args+".chatango.com", True)
             if rank == 3:
                 room.message("<br/><br/>[<f x13FF0000='0'>P<f x13FF6D00='0'>R<f x13FFDA00='0'>O<f x1392FF00='0'>F<f x1325FF00='0'>I<f x1300FF6D='0'>L<f x1300FFDA='0'>E<f x13D6061E='1'>]<br/>"+picture+"<br/> <f x13D6061E='1'>Usuário: <f x13FF0000='1'>"+args+"<br/><f x13D6061E='1'>Sexo: <f x13FF0000='1'>"+gender+"<br/><f x13D6061E='1'>Idade: <f x13FF0000='1'>"+age+"<br/><f x13D6061E='1'> País: <f x13FF0000='1'>"+location+" <f x13D6061E='1'><br/>Rank: <f x13A9D0F5='1'> [3 - Assistant] <f x13FF0040='1'>"+"<br/><f x13D6061E='1'> Status:<f x1333FF33='1'> Online"+"<br/> <f x13D6061E='1'> Perfil completo: <f x136666CC='1'> http://barrykun.com/?"+args+"<f x13D6061E='1'> ou <f x136666CC='1'> http://"+args+".chatango.com", True)
             if rank == 4:
                 room.message("<br/><br/>[<f x13FF0000='0'>P<f x13FF6D00='0'>R<f x13FFDA00='0'>O<f x1392FF00='0'>F<f x1325FF00='0'>I<f x1300FF6D='0'>L<f x1300FFDA='0'>E<f x13D6061E='1'>]<br/>"+picture+"<br/> <f x13D6061E='1'>Usuário: <f x13FF0000='1'>"+args+"<br/><f x13D6061E='1'>Sexo: <f x13FF0000='1'>"+gender+"<br/><f x13D6061E='1'>Idade: <f x13FF0000='1'>"+age+"<br/><f x13D6061E='1'> País: <f x13FF0000='1'>"+location+" <f x13D6061E='1'><br/>Rank: <f x139F81F7='1'> [4 - Mod] <f x13FF0040='1'>"+"<br/><f x13D6061E='1'> Status:<f x1333FF33='1'> Online"+"<br/> <f x13D6061E='1'> Perfil completo: <f x136666CC='1'> http://barrykun.com/?"+args+"<f x13D6061E='1'> ou <f x136666CC='1'> http://"+args+".chatango.com", True)
             if rank == 5:
                 room.message("<br/><br/>[<f x13FF0000='0'>P<f x13FF6D00='0'>R<f x13FFDA00='0'>O<f x1392FF00='0'>F<f x1325FF00='0'>I<f x1300FF6D='0'>L<f x1300FFDA='0'>E<f x13D6061E='1'>]<br/>"+picture+"<br/> <f x13D6061E='1'>Usuário: <f x13FF0000='1'>"+args+"<br/><f x13D6061E='1'>Sexo: <f x13FF0000='1'>"+gender+"<br/><f x13D6061E='1'>Idade: <f x13FF0000='1'>"+age+"<br/><f x13D6061E='1'> País: <f x13FF0000='1'>"+location+" <f x13D6061E='1'><br/>Rank: <f x13FE9A2E='1'> [5 - Admin] <f x13FF0040='1'>"+"<br/><f x13D6061E='1'> Status:<f x1333FF33='1'> Online"+"<br/> <f x13D6061E='1'> Perfil completo: <f x136666CC='1'> http://barrykun.com/?"+args+"<f x13D6061E='1'> ou <f x136666CC='1'> http://"+args+".chatango.com", True)
             if rank == 6:
                 room.message("<br/><br/>[<f x13FF0000='0'>P<f x13FF6D00='0'>R<f x13FFDA00='0'>O<f x1392FF00='0'>F<f x1325FF00='0'>I<f x1300FF6D='0'>L<f x1300FFDA='0'>E<f x13D6061E='1'>]<br/>"+picture+"<br/> <f x13D6061E='1'>Usuário: <f x13FF0000='1'>"+args+"<br/><f x13D6061E='1'>Sexo: <f x13FF0000='1'>"+gender+"<br/><f x13D6061E='1'>Idade: <f x13FF0000='1'>"+age+"<br/><f x13D6061E='1'> País: <f x13FF0000='1'>"+location+" <f x13D6061E='1'><br/>Rank: <f x13FE2EF7='1'> [6 - Developer] <f x13FF0040='1'>"+"<br/><f x13D6061E='1'> Status:<f x1333FF33='1'> Online"+"<br/> <f x13D6061E='1'> Perfil completo: <f x136666CC='1'> http://barrykun.com/?"+args+"<f x13D6061E='1'> ou <f x136666CC='1'> http://"+args+".chatango.com", True)
...
################################################## CMD NORMAIS ###########################################################################
        ...
        if cmd == "cs" or cmd =="currentstats" and self.getAccess(room, user) >= 2:
          ...
          rank = self.getAccess(room, user)
          if rank == 2:
             room.message("<br/><br/><br/>  <f x12D6061E='1'> ★ Current Database Now ★"+"<br/>  <f x12D6061E='1'> Developer: <f x12FF0000='1'> "+str(b)+" <br/>  <f x12D6061E='1'> Admin: <f x12FF0000='1'> "+str(c)+"<br/>  <f x12D6061E='1'> Mod: <f x12FF0000='1'> "+str(d)+"<br/>  <f x12D6061E='1'> Assistant: <f x12FF0000='1'> "+str(e)+"<br/>  <f x12D6061E='1'> Registered: <f x12FF0000='1'> "+str(f)+"<f x12D6061E='1'> (termasuk Anda) <br/>  <f x12D6061E='1'> Blacklist: <f x12FF0000='1'> "+str(h)+"<br/>  <f x12D6061E='1'> Chat: <f x12FF0000='1'>"+str(a)+"<br/>  <f x12D6061E='1'> Nick: <f x12FF0000='1'>"+str(g) ,True)
          if rank == 3:
             room.message("<br/><br/><br/>  <f x12D6061E='1'> ★ Current Database Now  ★"+"<br/>  <f x12D6061E='1'> Developer: <f x12FF0000='1'> "+str(b)+" <br/>  <f x12D6061E='1'> Admin: <f x12FF0000='1'> "+str(c)+"<br/>  <f x12D6061E='1'> Mod: <f x12FF0000='1'> "+str(d)+"<br/>  <f x12D6061E='1'> Assistant: <f x12FF0000='1'> "+str(e)+"<f x12D6061E='1'> (termasuk Anda)<br/>  <f x12D6061E='1'> Registered: <f x12FF0000='1'> "+str(f)+"<br/>  <f x12D6061E='1'> Blacklist: <f x12FF0000='1'> "+str(h)+"<br/>  <f x12D6061E='1'> Chat: <f x12FF0000='1'>"+str(a)+"<br/>  <f x12D6061E='1'> Nick: <f x12FF0000='1'>"+str(g) ,True)
          if rank == 4:
             room.message("<br/><br/><br/>  <f x12D6061E='1'> ★ Current Database Now  ★"+"<br/>  <f x12D6061E='1'> Developer: <f x12FF0000='1'> "+str(b)+" <br/>  <f x12D6061E='1'> Admin: <f x12FF0000='1'> "+str(c)+"<br/>  <f x12D6061E='1'> Mod: <f x12FF0000='1'> "+str(d)+"<f x12D6061E='1'> (termasuk Anda)<br/>  <f x12D6061E='1'> Assistant: <f x12FF0000='1'> "+str(e)+"<br/>  <f x12D6061E='1'> Registered: <f x12FF0000='1'> "+str(f)+"<br/>  <f x12D6061E='1'> Blacklist: <f x12FF0000='1'> "+str(h)+"<br/>  <f x12D6061E='1'> Chat: <f x12FF0000='1'>"+str(a)+"<br/>  <f x12D6061E='1'> Nick: <f x12FF0000='1'>"+str(g) ,True)
          if rank == 5:
             room.message("<br/><br/><br/>  <f x12D6061E='1'> ★ Current Database Now  ★"+"<br/>  <f x12D6061E='1'> Developer: <f x12FF0000='1'> "+str(b)+" <br/>  <f x12D6061E='1'> Admin: <f x12FF0000='1'> "+str(c)+"<f x12D6061E='1'> (termasuk Anda)<br/>  <f x12D6061E='1'> Mod: <f x12FF0000='1'> "+str(d)+"<br/>  <f x12D6061E='1'> Assistant: <f x12FF0000='1'> "+str(e)+"<br/>  <f x12D6061E='1'> Registered: <f x12FF0000='1'> "+str(f)+"<br/>  <f x12D6061E='1'> Blacklist: <f x12FF0000='1'> "+str(h)+"<br/>  <f x12D6061E='1'> Chat: <f x12FF0000='1'>"+str(a)+"<br/>  <f x12D6061E='1'> Nick: <f x12FF0000='1'>"+str(g) ,True)
          if rank == 6:
             room.message("<br/><br/><br/>  <f x12D6061E='1'> ★ Current Database Now  ★"+"<br/>  <f x12D6061E='1'> Developer: <f x12FF0000='1'> "+str(b)+"<f x12D6061E='1'> (termasuk Anda) <br/>  <f x12D6061E='1'> Admin: <f x12FF0000='1'> "+str(c)+"<br/>  <f x12D6061E='1'> Mod: <f x12FF0000='1'> "+str(d)+"<br/>  <f x12D6061E='1'> Assistant: <f x12FF0000='1'> "+str(e)+"<br/>  <f x12D6061E='1'> Registered: <f x12FF0000='1'> "+str(f)+"<br/>  <f x12D6061E='1'> Blacklist: <f x12FF0000='1'> "+str(h)+"<br/>  <f x12D6061E='1'> Chat: <f x12FF0000='1'>"+str(a)+"<br/>  <f x12D6061E='1'> Nick: <f x12FF0000='1'>"+str(g) ,True)
        ...
        if cmd == "ping" and self.getAccess(room, user) >= 4:
           ...
           if args != "":
             if args not in self.roomnames:
               ...
               self.getRoom("animaiden-net").message("<br/><br/>Nama: %s <br/>Rooms: %s  <br/>Commmand: %s <br/>IP: %s" % (user.name, room.name, cmd, message.ip), True)    
               return
        ...
        if cmd == "rr":
          ...
          if days > 0:
            ...
            string += str(days) + " " + (days == 1 and " <f x12D6061E='1'>days" or " <f x12D6061E='1'>hari" ) + "<f x12FF0000='1'> "
 
          if len(string) > 0 or hours > 0:
 
            string += str(hours) + " " + (hours == 1 and " <f x12D6061E='1'>hours" or " <f x12D6061E='1'>jam" ) + "<f x12FF0000='1'> "
 
          if len(string) > 0 or minutes > 0:
 
            string += str(minutes) + " " + (minutes == 1 and " <f x12D6061E='1'>minutes" or " <f x12D6061E='1'>menit" ) + "<f x12FF0000='1'> "
 
          string += str(seconds) + " " + (seconds == 1 and " <f x12D6061E='1'>seconds" or " <f x12D6061E='1'>detik" )
          z=(random.choice(["701","721","710","701","781","761","731","733","732","782",]))
          x=(random.choice(["1","2","3","4","5"]))
          room.message("<br/><br/><br/><f x12D6061E='1'>[<f x12FF0000='0'>I<f x12FF2800='0'>N<f x12FF5000='0'>F<f x12FF7800='0'>O<f x12FFA000='0'>R<f x12FFC800='0'>M<f x12FFF000='0'>A<f x12D7FF00='0'>Ç<f x12AFFF00='0'>Ã<f x1287FF00='0'>O<f x125FFF00='0'> <f x1237FF00='0'>S<f x120FFF00='0'>E<f x1200FF28='0'>R<f x1200FF50='0'>V<f x1200FF78='0'>I<f x1200FFA0='0'>D<f x1200FFC8='0'>O<f x1200FFF0='0'>R<f x12D6061E='1'>]<br/><f x12D6061E='1'>Versão bot: <f x12FF0000='1'>2.0.1  <br/><f x12D6061E='1'>Versão sistema : <f x12FF0000='1'>Python 3.5.2 <br/><f x12D6061E='1'>Memoria: <f x12FF0000='1'>"+str(z)+"<f x12D6061E='1'>MB/<f x12FF0000='1'>32<f x12D6061E='1'>GB (Free: <f x12FF0000='1'>31<f x12D6061E='1'>GB) [<f x12FF0000='1'>1<f x12D6061E='1'>% ] <br/>Latencia: <f x12FF0000='1'>"+str(x)+"<f x12D6061E='1'>ms <br/>Servidor online: <f x12FF0000='1'>24<f x12D6061E='1'> dias<br/> Bot online: <f x12FF0000='1'>%s" % string, True)
        ...
        if cmd == "myip" and self.getAccess(room, user) >= 2:
            room.message("<f x12FF0000='1'>  "+user.name+"    <f x12D6061E='1'>   seu atual ip é   <f x12FF0000='1'>  "+message.ip+" ", True)
...
##suck
        if cmd == "suck" and self.getAccess(room, user) >= 2:
            room.message(" <f x12FF0000='1'>"+user.name+"<f x12D6061E='1'>-senpai menghisap >.< <f x12FF0000='1'>"+random.choice(room.usernames)+"<f x12D6061E='1'>-san Bem gostoso :o", True)
