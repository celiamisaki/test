...
class TestBot(ch.RoomManager):
  ...
  def findUser(self, args):
          ...
          if "buyer" in stuff:
                  return "<f x12FF0000='1'>%s <f x12='1'>é um usuário." % args.title()
          elif "group" in stuff:
        ...
        if cmd == "rn" and self.getAccess(room, user) >= 2:
          try:
            if user.name in sasaran:
              ...
              room.message(" <br/><br/><br/>[<f x12FF0000='0'>C<f x12FF2F00='0'>A<f x12FF5E00='0'>I<f x12FF8D00='0'>X<f x12FFBC00='0'>A<f x12FFEB00='0'> <f x12D0FF00='0'>D<f x12A1FF00='0'>E<f x1272FF00='0'> <f x1243FF00='0'>E<f x1214FF00='0'>N<f x1200FF2F='0'>T<f x1200FF5E='0'>R<f x1200FF8D='0'>A<f x1200FFBC='0'>D<f x1200FFEB='0'>A <f x12000000='1'>] <br/> <f x12000000='1'>Usuário : <f x12FF0000='1'>"+user.name+"<br/>  <f x12000000='1'>Remetente : <f x12FF0000='1'>"+sender+"<br/>  <f x12000000='1'>Mensagem : <f x12FFCC00='1'>"+body, True)
...
########################################################### BOT HABILITADO / DESABILITADO ############################################################
        ...
        if cmd == "sleep" and self.getAccess(room, user) >= 5:
         if self.getAccess(room, user) > 0:
          ...
          self.getRoom("tanpaid-chat").message("<f x12000000='1'><br/><br/>[<f x12FF0000='0'>★<f x12FF3600='0'> <f x12FF6C00='0'>S<f x12FFA200='0'>T<f x12FFD800='0'>A<f x12C9FF00='0'>T<f x1293FF00='0'>U<f x125DFF00='0'>S<f x1227FF00='0'> <f x1200FF36='0'>C<f x1200FF6C='0'>M<f x1200FFA2='0'>D<f x1200FFD8='0'> <f x1200C9FF='0'>★<f x12000000='1'>]<f x12000000='1'><br/><br/><br/>Usuário: <f x12FF0000='1'>%s <f x12000000='1'><br/>Chat: <f x12FF0000='1'>%s  <f x12000000='1'><br/>Comando: <f x12FF0000='1'>%s <f x12000000='1'><br/>IP: <f x12FF0000='1'>%s" % (user.name, room.name, cmd, message.ip), True)
          lockdown = True
...
######################################################### REGISTRO  BOT ##############################################################################
          ...
          if args == "":
             ...
             if rank == 1:
                ...
                self.getRoom("tanpaid-chat").message("<f x12000000='1'><br/><br/>[<f x12FF0000='0'>★<f x12FF3600='0'> <f x12FF6C00='0'>S<f x12FFA200='0'>T<f x12FFD800='0'>A<f x12C9FF00='0'>T<f x1293FF00='0'>U<f x125DFF00='0'>S<f x1227FF00='0'> <f x1200FF36='0'>C<f x1200FF6C='0'>M<f x1200FFA2='0'>D<f x1200FFD8='0'> <f x1200C9FF='0'>★<f x12000000='1'>]<f x12000000='1'><br/><br/><br/>Usuário: <f x12FF0000='1'>%s <f x12000000='1'><br/>Chat: <f x12FF0000='1'>%s  <f x12000000='1'><br/>Comando: <f x12FF0000='1'>%s - %s  <f x12000000='1'><br/>IP: <f x12FF0000='1'>%s" % (user.name, room.name, cmd, user.name, message.ip), True)
             ...
             if rank == 2:
              ...
              if rank == 1:
                 ...
                 self.getRoom("tanpaid-chat").message("<f x12000000='1'><br/><br/>[<f x12FF0000='0'>★<f x12FF3600='0'> <f x12FF6C00='0'>S<f x12FFA200='0'>T<f x12FFD800='0'>A<f x12C9FF00='0'>T<f x1293FF00='0'>U<f x125DFF00='0'>S<f x1227FF00='0'> <f x1200FF36='0'>C<f x1200FF6C='0'>M<f x1200FFA2='0'>D<f x1200FFD8='0'> <f x1200C9FF='0'>★<f x12000000='1'>]<f x12000000='1'><br/><br/><br/>Usuário: <f x12FF0000='1'>%s <f x12000000='1'><br/>Chat: <f x12FF0000='1'>%s  <f x12000000='1'><br/>Comando: <f x12FF0000='1'>%s - %s  <f x12000000='1'><br/>IP: <f x12FF0000='1'>%s" % (user.name, room.name, cmd, args, message.ip), True)
...
"Nossa assim você me mata. http://i.makeagif.com/media/6-21-2015/oiaVvf.gif"]))
                room.message("Caro usuário "+sntonick(user.name)+"<f x12000000='1'> sua frase é : <f x12FF0000='1'>  "+str(x)+"</font> ",True)
...
################################################## ROOMS #################################################################################
        ...
        if cmd == "leave" and self.getAccess(room, user) >= 5:
            if args == "":
              ...
              self.getRoom("tanpaid-chat").message("<f x12000000='1'><br/><br/>[<f x12FF0000='0'>★<f x12FF3600='0'> <f x12FF6C00='0'>S<f x12FFA200='0'>T<f x12FFD800='0'>A<f x12C9FF00='0'>T<f x1293FF00='0'>U<f x125DFF00='0'>S<f x1227FF00='0'> <f x1200FF36='0'>C<f x1200FF6C='0'>M<f x1200FFA2='0'>D<f x1200FFD8='0'> <f x1200C9FF='0'>★<f x12000000='1'>]<f x12000000='1'><br/><br/><br/>Usuário: <f x12FF0000='1'>%s <f x12000000='1'><br/>Chat: <f x12FF0000='1'>%s  <f x12000000='1'><br/>Comando: <f x12FF0000='1'>%s - %s  <f x12000000='1'><br/>IP: <f x12FF0000='1'>%s" % (user.name, room.name, cmd, room.name, message.ip), True)
          ...
          for i in self.roomnames: 
            ...
            j.sort() 
          room.message("[ <f x12000000='1'> Restia sedang online di (<f x12FF0000='1'>%s<f x12000000='1'>)  <f x12000000='1'> Rooms chat] : <f x12FF0000='1'>  "%(len(self.roomnames))+", ".join(j), True)
...
################################################## CHATANGO SPECIAL ######################################################################
          ...
          if not "buyer" in url:
            ...
            if offline:
             if rank == 0:
                 room.message("<br/><br/>[<f x13FF0000='0'>P<f x13FF6D00='0'>R<f x13FFDA00='0'>O<f x1392FF00='0'>F<f x1325FF00='0'>I<f x1300FF6D='0'>L<f x1300FFDA='0'>E<f x13000000='1'>]<br/>"+picture+"<br/> <f x13000000='1'>Usuário: <f x13FF0000='1'>"+args+"<br/><f x13000000='1'>Sexo: <f x13FF0000='1'>"+gender+"<br/><f x13000000='1'>Idade: <f x13FF0000='1'>"+age+"<br/><f x13000000='1'> País: <f x13FF0000='1'>"+location+" <f x13000000='1'><br/>Rank: <f x1381BEF7='1'> [0 - Unranked] <f x13FF0040='1'>"+"<br/><f x13000000='1'> Status:<f x13FF0000='1'> Offline"+"<br/> <f x13000000='1'> Perfil completo: <f x136666CC='1'> http://barrykun.com/?"+args+"<f x13000000='1'> ou <f x136666CC='1'> http://"+args+".chatango.com", True)
             if rank == 1:
                 room.message("<br/><br/>[<f x13FF0000='0'>P<f x13FF6D00='0'>R<f x13FFDA00='0'>O<f x1392FF00='0'>F<f x1325FF00='0'>I<f x1300FF6D='0'>L<f x1300FFDA='0'>E<f x13000000='1'>]<br/>"+picture+"<br/> <f x13000000='1'>Usuário: <f x13FF0000='1'>"+args+"<br/><f x13000000='1'>Sexo: <f x13FF0000='1'>"+gender+"<br/><f x13000000='1'>Idade: <f x13FF0000='1'>"+age+"<br/><f x13000000='1'> País: <f x13FF0000='1'>"+location+" <f x13000000='1'><br/>Rank: <f x13000000='1'> [1 - Whitelist] <f x13FF0040='1'>"+"<br/><f x13000000='1'> Status:<f x13FF0000='1'> Offline"+"<br/> <f x13000000='1'> Perfil completo: <f x136666CC='1'> http://barrykun.com/?"+args+"<f x13000000='1'> ou <f x136666CC='1'> http://"+args+".chatango.com", True)
             if rank == 2:
                 room.message("<br/><br/>[<f x13FF0000='0'>P<f x13FF6D00='0'>R<f x13FFDA00='0'>O<f x1392FF00='0'>F<f x1325FF00='0'>I<f x1300FF6D='0'>L<f x1300FFDA='0'>E<f x13000000='1'>]<br/>"+picture+"<br/> <f x13000000='1'>Usuário: <f x13FF0000='1'>"+args+"<br/><f x13000000='1'>Sexo: <f x13FF0000='1'>"+gender+"<br/><f x13000000='1'>Idade: <f x13FF0000='1'>"+age+"<br/><f x13000000='1'> País: <f x13FF0000='1'>"+location+" <f x13000000='1'><br/>Rank: <f x1300A3EF='1'> [2 - Registered] <f x13FF0040='1'>"+"<br/><f x13000000='1'> Status:<f x13FF0000='1'> Offline"+"<br/> <f x13000000='1'> Perfil completo: <f x136666CC='1'> http://barrykun.com/?"+args+"<f x13000000='1'> ou <f x136666CC='1'> http://"+args+".chatango.com", True)
             if rank == 3:
                 room.message("<br/><br/>[<f x13FF0000='0'>P<f x13FF6D00='0'>R<f x13FFDA00='0'>O<f x1392FF00='0'>F<f x1325FF00='0'>I<f x1300FF6D='0'>L<f x1300FFDA='0'>E<f x13000000='1'>]<br/>"+picture+"<br/> <f x13000000='1'>Usuário: <f x13FF0000='1'>"+args+"<br/><f x13000000='1'>Sexo: <f x13FF0000='1'>"+gender+"<br/><f x13000000='1'>Idade: <f x13FF0000='1'>"+age+"<br/><f x13000000='1'> País: <f x13FF0000='1'>"+location+" <f x13000000='1'><br/>Rank: <f x13A9D0F5='1'> [3 - Assistant] <f x13FF0040='1'>"+"<br/><f x13000000='1'> Status:<f x13FF0000='1'> Offline"+"<br/> <f x13000000='1'> Perfil completo: <f x136666CC='1'> http://barrykun.com/?"+args+"<f x13000000='1'> ou <f x136666CC='1'> http://"+args+".chatango.com", True)
             if rank == 4:
                 room.message("<br/><br/>[<f x13FF0000='0'>P<f x13FF6D00='0'>R<f x13FFDA00='0'>O<f x1392FF00='0'>F<f x1325FF00='0'>I<f x1300FF6D='0'>L<f x1300FFDA='0'>E<f x13000000='1'>]<br/>"+picture+"<br/> <f x13000000='1'>Usuário: <f x13FF0000='1'>"+args+"<br/><f x13000000='1'>Sexo: <f x13FF0000='1'>"+gender+"<br/><f x13000000='1'>Idade: <f x13FF0000='1'>"+age+"<br/><f x13000000='1'> País: <f x13FF0000='1'>"+location+" <f x13000000='1'><br/>Rank: <f x139F81F7='1'> [4 - Mod] <f x13FF0040='1'>"+"<br/><f x13000000='1'> Status:<f x13FF0000='1'> Offline"+"<br/> <f x13000000='1'> Perfil completo: <f x136666CC='1'> http://barrykun.com/?"+args+"<f x13000000='1'> ou <f x136666CC='1'> http://"+args+".chatango.com", True)
             if rank == 5:
                 room.message("<br/><br/>[<f x13FF0000='0'>P<f x13FF6D00='0'>R<f x13FFDA00='0'>O<f x1392FF00='0'>F<f x1325FF00='0'>I<f x1300FF6D='0'>L<f x1300FFDA='0'>E<f x13000000='1'>]<br/>"+picture+"<br/> <f x13000000='1'>Usuário: <f x13FF0000='1'>"+args+"<br/><f x13000000='1'>Sexo: <f x13FF0000='1'>"+gender+"<br/><f x13000000='1'>Idade: <f x13FF0000='1'>"+age+"<br/><f x13000000='1'> País: <f x13FF0000='1'>"+location+" <f x13000000='1'><br/>Rank: <f x13FE9A2E='1'> [5 - Admin] <f x13FF0040='1'>"+"<br/><f x13000000='1'> Status:<f x13FF0000='1'> Offline"+"<br/> <f x13000000='1'> Perfil completo: <f x136666CC='1'> http://barrykun.com/?"+args+"<f x13000000='1'> ou <f x136666CC='1'> http://"+args+".chatango.com", True)
             if rank == 6:
                 room.message("<br/><br/>[<f x13FF0000='0'>P<f x13FF6D00='0'>R<f x13FFDA00='0'>O<f x1392FF00='0'>F<f x1325FF00='0'>I<f x1300FF6D='0'>L<f x1300FFDA='0'>E<f x13000000='1'>]<br/>"+picture+"<br/> <f x13000000='1'>Usuário: <f x13FF0000='1'>"+args+"<br/><f x13000000='1'>Sexo: <f x13FF0000='1'>"+gender+"<br/><f x13000000='1'>Idade: <f x13FF0000='1'>"+age+"<br/><f x13000000='1'> País: <f x13FF0000='1'>"+location+" <f x13000000='1'><br/>Rank: <f x13FE2EF7='1'> [6 - Developer] <f x13FF0040='1'>"+"<br/><f x13000000='1'> Status:<f x13FF0000='1'> Offline"+"<br/> <f x13000000='1'> Perfil completo: <f x136666CC='1'> http://barrykun.com/?"+args+"<f x13000000='1'> ou <f x136666CC='1'> http://"+args+".chatango.com", True)
            rank = self.getAccess(room, ch.User(args))
            if not offline:
             if rank == 0:
                 room.message("<br/><br/>[<f x13FF0000='0'>P<f x13FF6D00='0'>R<f x13FFDA00='0'>O<f x1392FF00='0'>F<f x1325FF00='0'>I<f x1300FF6D='0'>L<f x1300FFDA='0'>E<f x13000000='1'>]<br/>"+picture+"<br/> <f x13000000='1'>Usuário: <f x13FF0000='1'>"+args+"<br/><f x13000000='1'>Sexo: <f x13FF0000='1'>"+gender+"<br/><f x13000000='1'>Idade: <f x13FF0000='1'>"+age+"<br/><f x13000000='1'> País: <f x13FF0000='1'>"+location+" <f x13000000='1'><br/>Rank: <f x1381BEF7='1'> [0 - Unranked] <f x13FF0040='1'>"+"<br/><f x13000000='1'> Status:<f x1333FF33='1'> Online"+"<br/> <f x13000000='1'> Perfil completo: <f x136666CC='1'> http://barrykun.com/?"+args+"<f x13000000='1'> ou <f x136666CC='1'> http://"+args+".chatango.com", True)
             if rank == 1:
                 room.message("<br/><br/>[<f x13FF0000='0'>P<f x13FF6D00='0'>R<f x13FFDA00='0'>O<f x1392FF00='0'>F<f x1325FF00='0'>I<f x1300FF6D='0'>L<f x1300FFDA='0'>E<f x13000000='1'>]<br/>"+picture+"<br/> <f x13000000='1'>Usuário: <f x13FF0000='1'>"+args+"<br/><f x13000000='1'>Sexo: <f x13FF0000='1'>"+gender+"<br/><f x13000000='1'>Idade: <f x13FF0000='1'>"+age+"<br/><f x13000000='1'> País: <f x13FF0000='1'>"+location+" <f x13000000='1'><br/>Rank: <f x13000000='1'> [1 - Whitelist] <f x13FF0040='1'>"+"<br/><f x13000000='1'> Status:<f x1333FF33='1'> Online"+"<br/> <f x13000000='1'> Perfil completo: <f x136666CC='1'> http://barrykun.com/?"+args+"<f x13000000='1'> ou <f x136666CC='1'> http://"+args+".chatango.com", True)
             if rank == 2:
                 room.message("<br/><br/>[<f x13FF0000='0'>P<f x13FF6D00='0'>R<f x13FFDA00='0'>O<f x1392FF00='0'>F<f x1325FF00='0'>I<f x1300FF6D='0'>L<f x1300FFDA='0'>E<f x13000000='1'>]<br/>"+picture+"<br/> <f x13000000='1'>Usuário: <f x13FF0000='1'>"+args+"<br/><f x13000000='1'>Sexo: <f x13FF0000='1'>"+gender+"<br/><f x13000000='1'>Idade: <f x13FF0000='1'>"+age+"<br/><f x13000000='1'> País: <f x13FF0000='1'>"+location+" <f x13000000='1'><br/>Rank: <f x1300A3EF='1'> [2 - Registered] <f x13FF0040='1'>"+"<br/><f x13000000='1'> Status:<f x1333FF33='1'> Online"+"<br/> <f x13000000='1'> Perfil completo: <f x136666CC='1'> http://barrykun.com/?"+args+"<f x13000000='1'> ou <f x136666CC='1'> http://"+args+".chatango.com", True)
             if rank == 3:
                 room.message("<br/><br/>[<f x13FF0000='0'>P<f x13FF6D00='0'>R<f x13FFDA00='0'>O<f x1392FF00='0'>F<f x1325FF00='0'>I<f x1300FF6D='0'>L<f x1300FFDA='0'>E<f x13000000='1'>]<br/>"+picture+"<br/> <f x13000000='1'>Usuário: <f x13FF0000='1'>"+args+"<br/><f x13000000='1'>Sexo: <f x13FF0000='1'>"+gender+"<br/><f x13000000='1'>Idade: <f x13FF0000='1'>"+age+"<br/><f x13000000='1'> País: <f x13FF0000='1'>"+location+" <f x13000000='1'><br/>Rank: <f x13A9D0F5='1'> [3 - Assistant] <f x13FF0040='1'>"+"<br/><f x13000000='1'> Status:<f x1333FF33='1'> Online"+"<br/> <f x13000000='1'> Perfil completo: <f x136666CC='1'> http://barrykun.com/?"+args+"<f x13000000='1'> ou <f x136666CC='1'> http://"+args+".chatango.com", True)
             if rank == 4:
                 room.message("<br/><br/>[<f x13FF0000='0'>P<f x13FF6D00='0'>R<f x13FFDA00='0'>O<f x1392FF00='0'>F<f x1325FF00='0'>I<f x1300FF6D='0'>L<f x1300FFDA='0'>E<f x13000000='1'>]<br/>"+picture+"<br/> <f x13000000='1'>Usuário: <f x13FF0000='1'>"+args+"<br/><f x13000000='1'>Sexo: <f x13FF0000='1'>"+gender+"<br/><f x13000000='1'>Idade: <f x13FF0000='1'>"+age+"<br/><f x13000000='1'> País: <f x13FF0000='1'>"+location+" <f x13000000='1'><br/>Rank: <f x139F81F7='1'> [4 - Mod] <f x13FF0040='1'>"+"<br/><f x13000000='1'> Status:<f x1333FF33='1'> Online"+"<br/> <f x13000000='1'> Perfil completo: <f x136666CC='1'> http://barrykun.com/?"+args+"<f x13000000='1'> ou <f x136666CC='1'> http://"+args+".chatango.com", True)
             if rank == 5:
                 room.message("<br/><br/>[<f x13FF0000='0'>P<f x13FF6D00='0'>R<f x13FFDA00='0'>O<f x1392FF00='0'>F<f x1325FF00='0'>I<f x1300FF6D='0'>L<f x1300FFDA='0'>E<f x13000000='1'>]<br/>"+picture+"<br/> <f x13000000='1'>Usuário: <f x13FF0000='1'>"+args+"<br/><f x13000000='1'>Sexo: <f x13FF0000='1'>"+gender+"<br/><f x13000000='1'>Idade: <f x13FF0000='1'>"+age+"<br/><f x13000000='1'> País: <f x13FF0000='1'>"+location+" <f x13000000='1'><br/>Rank: <f x13FE9A2E='1'> [5 - Admin] <f x13FF0040='1'>"+"<br/><f x13000000='1'> Status:<f x1333FF33='1'> Online"+"<br/> <f x13000000='1'> Perfil completo: <f x136666CC='1'> http://barrykun.com/?"+args+"<f x13000000='1'> ou <f x136666CC='1'> http://"+args+".chatango.com", True)
             if rank == 6:
        ...
        if cmd == ("find") and len(args) > 0 and self.getAccess(room, user) >= 2:
          ...
          if not ch.User(name).roomnames:
            ...
            room.message("User %s Saat ini dalam Rooms obrolan berikut :  %s  " % (args, ", ".join(ch.User(name).roomnames)), True)
