        ...
        if cmd == "ban" or cmd == "banned" and self.getAccess(room, user) >= 4:
          if self.getAccess(room, user) > 0:
            if self.getAccess(room, user) > 0:
              ...
              room.message(" User   <f x11FF0000='1'>  "+args.title()+"   <f x1133FFFF='1'>  itu dilarang.", True)
            else:
        ...
        if cmd == "uban" or cmd == "unbanned" and self.getAccess(room, user) >= 4:
          ...
          if self.getAccess(room, user) > 0:
            if self.getAccess(room, user) > 0:
              ...
              room.message(" anda sudah di unban   <f x11FF0000='1'>  "+args.title()+"   <f x1133FFFF='1'>  , tidak menyalahgunakan aturan lagi, spam , sara ,link share.  ", True)
            else:
              room.message("Maaf Restia tidak memiliki (mod) di sini :(")
          else:
...
################################################## CMDS/RANK #############################################################################
          ...
          if args == "":
            ...
            if rank == 3:
              room.message("<br/><br/>★ RANK ★<br/> <f x1133FFFF='1'>User Name: <f x11FF0000='1'>"+user.name+" <f x1133FFFF='1'><br/>rank: <f x11A9D0F5='1'> [3 - Assistant] <f x11FF0040='1'>", True)
            if rank == 4:
            ...
            if rank == 6:
              ...
              if rank == 3:
                room.message("<br/><br/>★ RANK ★<br/> <f x1133FFFF='1'>User Name: <f x11FF0000='1'>"+args+" <f x1133FFFF='1'><br/>rank: <f x11A9D0F5='1'> [3 - Assistant] <f x11FF0040='1'>", True)
              if rank == 4:
...
#           try:
            ...
            if rank == 3:
              if target in assistant:
                room.message("<f x11FF0000='1'>  "+target.title()+"   <f x1133FFFF='1'> Selamat anda dipromosikan ke    <f x11A9D0F5='1'> [3 - Assistant]    <f x1133FFFF='1'>  Sekarang :D. ",True)
                return
              if target in blacklist:
                blacklist.pop(target)
              if target in admin:
...
################################################## CHATANGO SPECIAL ######################################################################
          ...
          if not "buyer" in url:
            ...
            if offline:
             ...
             if rank == 3:
                 room.message("<br/><br/>[<f x13FF0000='0'>P<f x13FF6D00='0'>R<f x13FFDA00='0'>O<f x1392FF00='0'>F<f x1325FF00='0'>I<f x1300FF6D='0'>L<f x1300FFDA='0'>E<f x1333FFFF='1'>]<br/>"+picture+"<br/> <f x1333FFFF='1'>Username: <f x13FF0000='1'>"+args+"<br/><f x1333FFFF='1'>Sex: <f x13FF0000='1'>"+gender+"<br/><f x1333FFFF='1'>Age: <f x13FF0000='1'>"+age+"<br/><f x1333FFFF='1'> Country: <f x13FF0000='1'>"+location+" <f x1333FFFF='1'><br/>Rank: <f x13A9D0F5='1'> [3 - Assistant] <f x13FF0040='1'>"+"<br/><f x1333FFFF='1'> Status:<f x13FF0000='1'> Offline"+"<br/> <f x1333FFFF='1'> Profile Complete: <f x136666CC='1'> http://barrykun.com/?"+args+"<f x1333FFFF='1'> ou <f x136666CC='1'> http://"+args+".chatango.com", True)
             if rank == 4:
            ...
            if not offline:
             ...
             if rank == 3:
                 room.message("<br/><br/>[<f x13FF0000='0'>P<f x13FF6D00='0'>R<f x13FFDA00='0'>O<f x1392FF00='0'>F<f x1325FF00='0'>I<f x1300FF6D='0'>L<f x1300FFDA='0'>E<f x1333FFFF='1'>]<br/>"+picture+"<br/> <f x1333FFFF='1'>Username: <f x13FF0000='1'>"+args+"<br/><f x1333FFFF='1'>Sex: <f x13FF0000='1'>"+gender+"<br/><f x1333FFFF='1'>Age: <f x13FF0000='1'>"+age+"<br/><f x1333FFFF='1'> Country: <f x13FF0000='1'>"+location+" <f x1333FFFF='1'><br/>Rank: <f x13A9D0F5='1'> [3 - Assistant] <f x13FF0040='1'>"+"<br/><f x1333FFFF='1'> Status:<f x1333FF33='1'> Online"+"<br/> <f x1333FFFF='1'> Profile Complete: <f x136666CC='1'> http://barrykun.com/?"+args+"<f x1333FFFF='1'> ou <f x136666CC='1'> http://"+args+".chatango.com", True)
             if rank == 4:
