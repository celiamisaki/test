...
########################################################## BLACKLIST #################################################################################
        ...
        if cmd.lower() == "ubl" and self.getAccess(room, user) >= 5:
              self.getRoom("animeaiden-net").message("<f x11000000='1'><br/><br/>[<f x11FF0000='0'>S<f x11FF4C00='0'>T<f x11FF9800='0'>A<f x11FFE400='0'>T<f x11B3FF00='0'>U<f x1167FF00='0'>S<f x11BFF00='0'> <f x1100FF4C='0'>C<f x1100FF98='0'>M<f x1100FFE4='0'>D<f x11000000='1'>]<f x11000000='1'><br/><br/><br/><b>Username</b>: <f x11FF0000='1'>%s <f x11000000='1'><br/><b>Chat</b>: <f x11FF0000='1'>%s  <f x11000000='1'><br/><b>Comando</b>: <f x11FF0000='1'>%s <f x11000000='1'><br/><b>IP</b>: <f x11FF0000='1'>%s" % (user.name, room.name, cmd, message.ip), True)    
...
################################################## ROOMS #################################################################################
        ...
        if cmd == "leave" and self.getAccess(room, user) >= 5:
          ...
          for i in self.roomnames: 
            ...
            j.sort() 
          room.message("[ <f x12000000='1'> Restia wa, onraindearimasu (<f x12FF0000='1'>%s<f x12000000='1'>)  <f x12000000='1'> Chattorūmu] : <f x12FF0000='1'>  "%(len(self.roomnames))+", ".join(j), True)
